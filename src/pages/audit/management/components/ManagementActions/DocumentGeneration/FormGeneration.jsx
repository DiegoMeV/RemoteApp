...
const FormGeneration = ({ elementAction, ids, generationForm }) => {
  ...
  const {
    ...
    qry: `/${elementAction?.templateData?.id}?includeFirmantesDefecto=true&idProceso=${idProcess}&idVersion=${elementAction?.templateData?.idVersion}`,
  })
