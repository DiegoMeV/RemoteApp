import { BasicTitle, ErrorPage, NoAccessCard } from '@/lib'
import { Box } from '@mui/material'
import { TableNotes } from './components'
import { useParams } from 'react-router-dom'
import { AccessControl, useQueryDynamicApi } from '@/libV4'
...
const NotesByProcess = () => {
  ...
  const {
    data: process,
    isFetching: loadingProcess,
    isError: errorProcess,
  } = useQueryDynamicApi({
    baseKey: 'urlFiscalizacion',
    url: `/processes/${idProcess}/comments`,
    enabled: !!idProcess,
  })
