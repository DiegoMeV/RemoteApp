import { CustomModal, downloadBuffer, useBoolean, useGetBufferDocument } from '@/lib'
...
const UploadDocuments = ({ form, setActiveStep }) => {
  ...
  const downloadTemplate = () => {
    if (!form.watch('idTemplate')) {
      toast.error('Asegurese de seleccionar una plantilla en el tipo de proceso')
      return
    }
  ...
  return (
    ...
    >
      ...
      <CustomModal
        ...
        title='Asistente de importación de datos de información exógena'
        size={'xl'}
        height={'80vh'}
      >
        <ModalUploadFiles
          ...
          body={'arrayData'}
          pushUrl={`/${infoTypeDoc.id}/subject/massiveInsert`}
          pushBase={'/inspectionPlan'}
        />
      </CustomModal>
    </Box>
  )
