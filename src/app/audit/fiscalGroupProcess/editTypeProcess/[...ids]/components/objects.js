export const generalVar = [
  ...
  {
    label: 'Tipo de generación de expedientes',
    type: 'select',
    name: 'dataSourceType',
    md: 4,
    options: [
      { label: 'Endógeno', value: 'INTERNAL' },
      { label: 'Exógeno', value: 'EXTERNAL' },
    ],
  },
  {
  ...
  { label: 'Tiempo de gestión', type: 'number', name: 'duration', md: 6 },
  {
