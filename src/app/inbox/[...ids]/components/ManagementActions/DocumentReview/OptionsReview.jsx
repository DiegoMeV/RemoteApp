...
const OptionsReview = ({
  ...
  const handleFinishManagement = (documentStatus) => {
    setConfirmAlertProps({
      open: true,
      icon: 'info',
      title: 'Confirmar',
      content: '¿Está seguro que desea rechazar el documento?',
      onConfirm: () => {
        reviewFunc(documentStatus)
      },
    })
  }
          ...
          <ClassicIconButton
            ...
            onClick={() =>
              handleFinishManagement(
                idGoToTask ? documentStatus.rejectedToTask : documentStatus.rejected
              )
            }
            color='error'
          >
