...
const RegistryInternalCorrespondence = () => {
  ...
  const props = {
    ...
    stepsLabels: ['Datos básicos', 'Destinatario(s) externo(s)', 'Destinatario(s) interno(s)'],
    setActiveStep,
    finalStep: 2,
  }
...
export default RegistryInternalCorrespondence
