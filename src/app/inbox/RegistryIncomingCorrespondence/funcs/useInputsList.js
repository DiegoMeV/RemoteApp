...
export const useInputsList = (
  ...
  const inputsList = [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'BUZON_DE_SUGERENCIAS', label: 'Buzón de sugerencias' },
    ...
    {
      name: 'ResponseNumber',
      label: 'Número a citar para respuesta',
      type: 'freeText',
      space: form?.watch('receptionMethod') === 'CORREO_ELECTRONICO' ? 4 : 3,
    },
    {
      name: 'FoliosNumber',
  ...
  if (form?.watch('receptionMethod') === 'CORREO_ELECTRONICO') {
    inputsList.splice(7, 0, {
      name: 'email',
      label: 'Correo electrónico',
      type: 'email',
      space: 6,
    })
    inputsList.splice(8, 0, {
      name: 'dateEmail',
      label: 'Fecha',
      type: 'date',
      space: 4,
