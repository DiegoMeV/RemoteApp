...
import { PayOrderRowMenu } from '.'

const PayOrderOptions = ({ setIdProcess, openModals, item }) => {
  ...
  return (
    ...
    >
      <Box>
        <ClassicIconButton onClick={handlePreview}>
          <PictureAsPdf />
        </ClassicIconButton>
        {/* <ClassicIconButton onClick={onClickRejectPaymentOrder}>
          <Undo />
        </ClassicIconButton> */}
      </Box>
      <PayOrderRowMenu treasuryOptions={menuItems} />
    </Box>
  )
}

export default PayOrderOptions
