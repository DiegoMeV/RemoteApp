...
export const onClickRegenerarValor = async ({
  ...
  const tipo = getFormValue('orden_pago.tipo')
  const params = {
    P_Nit_compania: {
      type: 'IN',
      value: nit_compania,
    ...
    P_Nro_Contrato: {
      type: 'IN',
      value: getFormValue('orden_pago.nro_contrato'),
    },
    P_Tipo_Contrato: {
      type: 'IN',
      value: getFormValue('orden_pago.tipo_contrato'),
    },
    P_Anticipo: {
      type: 'IN',
    ...
    P_Valor_Embargo: {
      type: 'IN',
      value: getFormValue('orden_pago.valor_embargo'),
    },
    P_Valor: {
      type: 'OUT',
    },
  ...
  setFormValue('orden_pago.valor', responseData?.P_Valor)
  setFormValue('orden_pago.iva', responseData?.P_Iva)
  setFormValue('orden_pago.total_orden', responseData?.P_Total_orden)
